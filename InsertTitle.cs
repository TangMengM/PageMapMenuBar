...
{
    class InsertTitle : MyPluginEngine.ITool
    {
        ...
        public InsertTitle()
        {
            m_hBitmap = new Bitmap(this.GetType().Assembly.GetManifestResourceStream("PageMapMenuBar.Image.标题.ico"));
        }
