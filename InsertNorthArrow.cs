...
{
    class InsertNorthArrow : MyPluginEngine.ITool
    {
        ...
        public InsertNorthArrow()
        {
            m_hBitmap = new Bitmap(this.GetType().Assembly.GetManifestResourceStream("PageMapMenuBar.Image.指北针.ico"));
        }
        ...
        public void OnMouseDown(int button, int shift, int x, int y)
        {
            ...
            MapSurroundImp.CreateMapSurround(uid, env, "指北针", this.hk.PageLayoutControl, null);
        }
